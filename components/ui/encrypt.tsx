...
const EncryptButton = () => {
  ...
  return (
    <motion.button
      ...
      className="group relative overflow-hidden rounded-lg border-[1px] border-neutral-500 bg-black px-2 py-1 font-mono font-medium uppercase text-neutral-300 transition-colors hover:text-cyan-300"
    >
